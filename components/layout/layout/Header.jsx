    ...
    >
      <div className="container mx-auto text-white flex justify-between items-center h-full">
        ...
        <div className="flex gap-x-4 items-center">
          ...
          <a href="https://fonzip.com/turkiyesmavakfi/bagis" target="_blank" className="md:inline-block hidden sm">
            <button className="btn-primary">Bağışta Bulun</button>
          </a>
          <button
